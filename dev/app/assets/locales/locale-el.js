...
trade_warn_msg:{
	select_backup_asset: "Δημιουργήσετε αντίγραφα ασφαλείας περιουσιακό στοιχείο δεν είναι επιλεγμένο στις ρυθμίσεις. Παρακαλούμε επιλέξτε την πρώτη",
	low_balance_backup_asset: "Δεν έχετε αρκετή ισορροπία στο εμπόριο. Παρακαλώ επιλέξτε άλλο αντίγραφο ασφαλείας του ενεργητικού",
	other_backup_asset: "ισοτιμία δεν είναι διαθέσιμη. Παρακαλώ επιλέξτε άλλο αντίγραφο ασφαλείας του ενεργητικού",
	cannot_pay: "Δεν μπορείτε να πληρώσετε. Έχετε χαμηλή ισορροπία"
},
