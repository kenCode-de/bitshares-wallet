...
trade_warn_msg:{
	select_backup_asset: "Резервну копију средство није изабрана у подешавањима. Молимо одаберите прво",
	low_balance_backup_asset: "Не морате довољно баланс за трговину. Молимо одаберите другу резервну имовину",
	other_backup_asset: "Девизни курс није доступан. Молимо одаберите другу резервну имовину",
	cannot_pay: "Ви не можете платити. Имате ниску стање"
},
