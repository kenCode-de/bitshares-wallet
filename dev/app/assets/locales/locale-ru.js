...
exchange: {
    ...
    trade : "СДЕЛКА",
    trade_msg: "У вас нет активов, которые торговец хочет. Вы хотите получить?"
},

trade_warn_msg:{
	select_backup_asset: "Резервное копирование актив не выбран в настройках. Пожалуйста, выберите первую",
	low_balance_backup_asset: "Вам не хватает баланса в торговле. Пожалуйста, выберите другой резервный актив",
	other_backup_asset: "Курс обмена не доступен. Пожалуйста, выберите другой резервный актив",
	cannot_pay: "Вы не можете заплатить. У вас есть низкий баланс"
},
