            ...
            if (this.state.outOfBalance)
                ...
                if (state && state.hasOwnProperty("payment")) {   
                  ...
                  for(var i=0; i<asset_types.length; i++){    
                    ...
                    if(reward_found){   
                      reward_uia = (<span className="avalibel-label"   >   
                      <RewardUia
                      onChange={this.onRewardPointsChanged.bind(this)}
                      onBlur={this.onRewardPointsBlured.bind(this)} />
                      <BalanceComponent  ref="bc2" balance={account_balances[this.state.ruia]}/> <Translate component="span" content="wallet.transfer_available"/></span>)    
                    }   
                    else{   
